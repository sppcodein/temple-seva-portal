 ...
 * @since 1.0.0
 */
define( 'TEMPLE_SEVA_PORTAL_VERSION', wp_get_theme()->get( 'Version' ) );
 ...
 * @return void
 */
function temple_seva_portal_setup() {
	...
	foreach ( $styled_blocks as $block_name ) {
		$args = array(
			'handle' => "temple-seva-portal-$block_name",
...
add_action( 'after_setup_theme', 'temple_seva_portal_setup' );
